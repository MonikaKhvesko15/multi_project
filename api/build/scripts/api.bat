...
set CLASSPATH=%APP_HOME%\lib\api.jar;%APP_HOME%\lib\core.jar;%APP_HOME%\lib\lib-1.3.5.jar;%APP_HOME%\lib\guava-29.0-jre.jar;%APP_HOME%\lib\commons-lang3-3.10.jar;%APP_HOME%\lib\failureaccess-1.0.1.jar;%APP_HOME%\lib\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\checker-qual-2.11.1.jar;%APP_HOME%\lib\error_prone_annotations-2.3.4.jar;%APP_HOME%\lib\j2objc-annotations-1.3.jar


@rem Execute api
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %API_OPTS%  -classpath "%CLASSPATH%" com.epam.App %*
